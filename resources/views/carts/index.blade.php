...
.col-md-4 {
    flex: 1 0 20%; /* 基本的な幅を20%に設定 */
    max-width: 20%; /* 最大幅を20%に設定 */
...
.card {
    ...
    height: 100%; /* 高さを100%に設定して均等に配置 */
}

.card-body {
    flex-grow: 1; /* 内容が均等に拡張されるように設定 */
}

/* 画面幅が768px以上（タブレット・デスクトップ）で3列表示 */
@media (min-width: 768px) {
    .col-md-4 {
        flex: 1 0 30%; /* 幅を30%に変更して3列表示 */
        max-width: 33.33%; /* 最大幅を33.33%に設定 */
    }
}

/* 画面幅が992px以上（デスクトップ）で4列表示 */
@media (min-width: 992px) {
    .col-md-4 {
        flex: 1 0 25%; /* 幅を25%に変更して4列表示 */
        max-width: 25%; /* 最大幅を25%に設定 */
    }
}

/* 画面幅が1200px以上（大きなスクリーン）で5列表示 */
@media (min-width: 1200px) {
    .col-md-4 {
        flex: 1 0 20%; /* 幅を20%に設定して5列表示 */
        max-width: 20%; /* 最大幅を20%に設定 */
    }
}
